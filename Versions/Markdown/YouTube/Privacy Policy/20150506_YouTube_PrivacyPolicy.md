...
using the DoubleClick cookie, Google Analytics information is **linked, by the Google Analytics customer or by**

**Google, using Google technology, with information about visits to multiple sites**.
